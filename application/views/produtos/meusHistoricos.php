...
<div class="body-content">
    <div class="container">
        <div class="checkout-box faq-page">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="heading-title">Histórico de Compra</h2>
                                                    ...
                                                    foreach ($itensCupom as $item) {
                                                        if ($c->cupom_token == $item->transacao_token) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><br>
                                                                <?php if($item->transacao_avaliacao_produto == '0') { ?>
                                                                        <a href="<?= base_url('produto/avaliarView/' . $item->transacao_id) ?>" class="btn btn-primary btn-lg">Avaliar</a>
                                                                    <?php } ?>
                                                                </td> 
                                                            </tr>    
                                                            <?php
