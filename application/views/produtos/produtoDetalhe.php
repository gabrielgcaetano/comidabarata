                                ...
                                <div class="item">
                                    <div class="products">
                                        <div class="hot-deal-wrapper">
                                            <div class="image">
                                                <img  src="<?= base_url(); ?>images/<?= $prodd->produto_foto; ?>" alt="">
                                            </div>
                                        </div>
                                    ...
                                    <div class="product-info text-left m-t-20">
                                        ...
                                        <div class="product-price">	
                                            <span class="price">R$ <?= $prodd->produto_preco_velho; ?></span>

                                            <span class="price-before-discount">R$ <?= $prodd->produto_preco_novo; ?></span>					
                                ...
                                <div id="owl-single-product">
                                    <div class="single-product-gallery-item" id="slide1">
                                        <a data-lightbox="image-1" data-title="<?= $produto[0]->produto_nome ?>" href="<?= base_url(); ?>images/<?= $produto[0]->produto_foto; ?>">
                                            <img class="img-responsive" alt="" src="<?= base_url(); ?>images/<?= $produto[0]->produto_foto; ?>" />
                                        </a>
                                ...
                                <form method="post" action="<?= base_url('produto/carrinho') ?>"
                                    ...
                                    <div class="price-container info-container m-t-20">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="price-box">
                                                    <span class="price">R$ <?= $produto[0]->produto_preco_novo ?></span>
                                                    <span class="price-strike">R$ <?= $produto[0]->produto_preco_velho ?></span>
                                                </div>
                                            </div>
                                ...
                                <div class="products">
                                    <div class="product">		
                                        <div class="product-image">
                                            <div class="image">
                                                <a href="<?= base_url(); ?>produto/detalheProduto/<?= $aEmpresa->produto_id ?>"><img  src="<?= base_url(); ?>images/<?= $aEmpresa->produto_foto; ?>" alt=""></a>
                                            </div><!-- /.image -->			
                                        </div><!-- /.product-image -->
                                        ...
                                        <div class="product-info text-left">
                                            ...
                                            <div class="product-price">	
                                                <span class="price"> R$ <?= $aEmpresa->produto_preco_novo; ?> </span>
                                                <span class="price-before-discount"> R$ <?= $aEmpresa->produto_preco_velho; ?> </span>
