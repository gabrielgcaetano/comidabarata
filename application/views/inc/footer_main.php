            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="module-heading">
                        <h4 class="module-title">Contato</h4>
                    </div><!-- /.module-heading -->
                    ...
                    <div class="module-body">
                        <ul class="toggle-footer" style="">
                            ...
                            <li class="media">
                                ...
                                <div class="media-body">
                                    <span><a href="#">gabriel@comidabarata.com.br</a></span>
                                </div>
                            </li>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="module-heading">
                        <h4 class="module-title">Serviço ao Cliente</h4>
                    </div><!-- /.module-heading -->

                    <div class="module-body">
                        <ul class='list-unstyled'>
                            <li class="first"><a href="#" title="Contact us">Minha Conta</a></li>
                            <li><a href="#" title="About us">Minhas Compras</a></li>
