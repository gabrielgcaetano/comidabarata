            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 create-new-account">
                    ...
                    <form class="register-form outer-top-xs" role="form" method="post" action="<?= base_url() ?>user/register_save" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            <label class="info-title" for="exampleInputEmail1">Documento <span>*</span></label>
                            <input type="text" class="form-control unicase-form-control text-input" id="user_documento" name="user_documento"  placeholder="CPF">
                        </div>
                        <div class="form-group">
